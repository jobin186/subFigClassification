...
%imdb.patchSize=224;
%imdb.stride =100;
imdb.feature = featur; % {'dcnn', 'rcnn','drcnn', 'hog', 'gabor'}
imdb.expDir = ['/home/jobinkv/clsiiSubFig/exp01/',imdb.feature]; % 9--> 1:8k,10-->1:end
opts.useGpu = true;
...
for i = 1:imdb.batchSize:3300 %numel(imdb.Sets{2}.imagePath)
        tic
